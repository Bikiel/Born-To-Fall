...
public class SpawnManagerX : MonoBehaviour
{
    ...
    void Start()
    {
        spawnInterval = UnityEngine.Random.Range(3, 5);
    ...
    void SpawnRandomBall ()
    {
        ...
        //choose a random ball from the array of ball prefabs
        int whichBall = UnityEngine.Random.Range(0, ballPrefabs.Length);
